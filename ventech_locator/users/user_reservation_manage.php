...
<body class="bg-gray-100 p-4 md:p-6 lg:p-8">
    <div class="max-w-3xl mx-auto"> <header class="bg-white shadow-md rounded-lg p-6 mb-8 flex justify-between items-center">
            <div>
             ...
             <a href="/ventech_locator/client_dashboard.php" class="bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded text-sm font-medium transition duration-150 ease-in-out shadow-sm">
                    ...
                    <div class="reservation-item <?= $status_class ?> rounded-lg shadow-md overflow-hidden flex flex-col transition duration-300 ease-in-out hover:shadow-lg">
                        ...
                        <div class="p-4 md:p-5 flex flex-col flex-grow">
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                ...
                                <?php // Add Cancel button for pending or accepted reservations ?>
                                <?php if (strtolower($res['status'] ?? '') === 'pending' || strtolower($res['status'] ?? '') === 'accepted'): ?>
                                    <div class="mt-3">
                                ...
                                <a href="/ventech_locator/reservation_manage_details.php?id=<?= htmlspecialchars($res['id'] ?? '') ?>" class="mt-3 inline-block text-xs text-blue-600 hover:text-blue-800 font-medium">
                                     <i class="fas fa-info-circle mr-1"></i> View Full Details &rarr;
                                 </a>
                            </div>
                        </div>
                    </div>

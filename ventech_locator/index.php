...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha5512-9usAa10IRO0HhonpyAIVpjrylPvoDwiPUiKdWk5t3PyolY1cOd4DSE0Ga+ri4AuTroPR5aQvXU9xC6qOPnzFeg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css" />
    <style>
         @import url("https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap"); /* Changed to Inter for consistency */
    body {
...
<body class="font-inter bg-gray-100 antialiased">
    <header class="relative">
        <img src="/ventech_locator/images/header.jpg" alt="Modern Venue Space" class="w-full h-96 object-cover brightness-75" />
        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/50 to-transparent flex flex-col justify-between items-center text-center text-white p-4 md:p-8">
                ...
                <nav class="hidden md:flex space-x-4 md:space-x-6 lg:space-x-8 items-center text-sm md:text-base">
                    ...
                    <div class="relative fade-in fade-in-3">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden z-30 transition-all duration-300 ease-in-out origin-top-right" id="dropdownMenu" role="menu" aria-orientation="vertical" aria-labelledby="signInButton">
                            <a href="/ventech_locator/users/user_login.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-gray-900 transition-colors duration-150 rounded-t-md" role="menuitem">User</a>
                            <a href="/ventech_locator/client/client_login.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-gray-900 transition-colors duration-150" role="menuitem">Client/Owner Login</a>
                ...
                <nav class="flex flex-col space-y-6 mt-12">
                    ...
                    <div class="relative">
                        ...
                        <div class="mt-2 w-full bg-gray-700 rounded-md shadow-lg py-1 hidden transition-all duration-300 ease-in-out origin-top-right" id="mobileDropdownMenu" role="menu" aria-orientation="vertical" aria-labelledby="mobileSignInButton">
                            <a href="/ventech_locator/users/user_login.php" class="block px-4 py-2 text-base text-gray-200 hover:bg-yellow-600 hover:text-white transition-colors duration-150 rounded-t-md" role="menuitem">User</a>
                            <a href="/ventech_locator/client/client_login.php" class="block px-4 py-2 text-base text-gray-200 hover:bg-yellow-600 hover:text-white transition-colors duration-150" role="menuitem">Client/Owner Login</a>
            ...
            <div class="hero-overlay-content flex flex-col items-center justify-center flex-grow pb-12 md:pb-16 px-4 md:px-0">
                <h1 class="text-2xl md:text-3xl uppercase tracking-wider fade-in fade-in-4 font-semibold">Welcome to</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 md:py-20 bg-grey rounded-lg mb-12">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-12 md:gap-24">
             <div class="max-w-xl w-full space-y-6">
                <h1 class="text-3xl md:text-4xl font-bold leading-tight mb-4 fade-in fade-in-1 text-gray-800">Connect your space with students around Bacoor Cavite!</h1>
                ...
                <ul class="space-y-5 mb-10 max-w-md">
                    <li class="flex items-start gap-4 fade-in fade-in-3">
                        <i class="fas fa-credit-card text-xl mt-1 text-blue-600"></i> <span class="text-base md:text-lg text-gray-700">From club meetings to campus parties—discover and book venues in Bacoor Cavite, fast and easy.</span>
                    </li>
                    <li class="flex items-start gap-4 fade-in fade-in-4">
                        <i class="fas fa-wallet text-xl mt-1 text-green-600"></i> <span class="text-base md:text-lg text-gray-700">Find the Perfect Space for Every Student Event </span>
                    </li>
                    <li class="flex items-start gap-4 fade-in fade-in-5">
                        <i class="fas fa-calendar-check text-xl mt-1 text-purple-600"></i> <span class="text-base md:text-lg text-gray-700">Connecting Students to the Right Spaces.</span>
                    </li>
                    <li class="flex items-start gap-4 fade-in fade-in-6">
                        <i class="fas fa-search text-xl mt-1 text-red-600"></i> <span class="text-base md:text-lg text-gray-700">Find your perfect student activity venue, faster.</span>
                    </li>
                    <li class="flex items-start gap-4 fade-in fade-in-7">
                        <i class="fas fa-rocket text-xl mt-1 text-orange-600"></i> <span class="text-base md:text-lg text-gray-700">Fast online application in 90 seconds</span>
                    </li>
                </ul>
                <button id="listVenueButton" class="bg-[#f4f94e] text-black font-semibold rounded-full px-8 py-3 text-base md:text-lg hover:bg-yellow-400 transition transform hover:scale-105 duration-300 shadow-md" type="button"> List Your Venue
                </button>
            </div>
            
            <div class="flex-shrink-0 w-full max-w-md md:max-w-none md:w-[480px] fade-in">
                <img
                    alt="Atome card image showing three credit cards floating on a bright yellow background"
                    class="w-full h-auto object-contain rounded-lg shadow-md transition transform hover:scale-105 duration-300" src="/ventech_locator/images/section.png"
                        ...
                        <?php foreach ($venues as $venue):
                            ...
                            if (!empty($clientAddress)) {
                                ...
                                if (!empty($venue['google_map_url'])) {
                                    ...
                                    $locationText = "Lat: " . htmlspecialchars($venue['latitude']) . ", Lon: " . htmlspecialchars($venue['longitude']);
                                } else {
                            ...
                            if (!empty($venue['google_map_url'])) {
                                ...
                                $directionsUrl = "https://www.google.com/maps/dir/?api=1&destination=" . urlencode($venue['latitude'] . "," . $venue['longitude']) . "&travelmode=driving";
                            } else {
                                // Use the displayed location text for directions if no specific URL/coords are available
                                $directionsUrl = "https://www.google.com/maps/search/?api=1&query=" . urlencode($locationText);
                            }
                            ?>
                            <div class="flex flex-col bg-white rounded-lg shadow-md overflow-hidden">
                                <div class="relative rounded-lg overflow-hidden">
                                    <img alt="<?= htmlspecialchars($venue['title'] ?? 'Venue Image') ?>" class="w-full h-[200px] object-cover rounded-lg" height="200" src="<?= $imgSrc ?>" width="320" loading="lazy" onerror="this.onerror=null;this.src='<?= $placeholderImg ?>';"/>
                                    </div>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 md:py-20 bg-grey rounded-lg mb-12">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-12 md:gap-24">
            <div class="flex-shrink-0 w-full max-w-md md:max-w-none md:w-[480px] fade-in">
                <img
                    alt="Atome card image showing three credit cards floating on a bright yellow background"
                    class="w-full h-auto object-contain rounded-lg shadow-md transition transform hover:scale-105 duration-300" src="/ventech_locator/images/photo-index.png"
                    width="480" height="600"
                />
            </div>
            <div class="max-w-xl w-full space-y-6">
                <h1 class="text-3xl md:text-4xl font-bold leading-tight mb-4 fade-in fade-in-1 text-gray-800">Your Next Student Event, Starts Here.</h1>
                <p class="text-base md:text-lg mb-8 max-w-md fade-in fade-in-2 text-gray-700 leading-relaxed">
                            Student Activities: Find Your Perfect Space.
                </p>
                <ul class="space-y-5 mb-10 max-w-md">
                    <li class="flex items-start gap-4 fade-in fade-in-3">
                        <i class="fas fa-credit-card text-xl mt-1 text-blue-600"></i> <span class="text-base md:text-lg text-gray-700">From study sessions to major events, find the perfect space effortlessly.</span>
                    </li>
                    <li class="flex items-start gap-4 fade-in fade-in-4">
                        <i class="fas fa-wallet text-xl mt-1 text-green-600"></i> <span class="text-base md:text-lg text-gray-700">Seamlessly locate and secure the best venues for all your student activities. </span>
                    </li>
                    <li class="flex items-start gap-4 fade-in fade-in-5">
                        <i class="fas fa-calendar-check text-xl mt-1 text-purple-600"></i> <span class="text-base md:text-lg text-gray-700">Discover and book the ideal venue for every student activity with ease.</span>
                    </li>
                    <li class="flex items-start gap-4 fade-in fade-in-6">
                        <i class="fas fa-search text-xl mt-1 text-red-600"></i> <span class="text-base md:text-lg text-gray-700">Find your perfect student activity venue, faster.</span>
                    </li>
                ...
                <button class="bg-[#f4f94e] text-black font-semibold rounded-full px-8 py-3 text-base md:text-lg hover:bg-yellow-400 transition transform hover:scale-105 duration-300 shadow-md" type="button"> Learn more
                </button>
            </div>
        </div>
    </main>
        ...
        document.addEventListener('DOMContentLoaded',      function     () {
            ...
            if (listVenueButton) {
                listVenueButton.addEventListener('click', function(event) {
                    ...
                    if (!isLoggedIn || (userRole !== 'client' && userRole !== 'admin')) {
                        // Display custom alert message
                        const messageBox = document.createElement('div');
                        messageBox.className = 'fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50';
                        messageBox.innerHTML = `
                            <div class="bg-white p-6 rounded-lg shadow-xl max-w-sm w-full text-center">
                                <p class="text-lg font-semibold mb-4">You must be registered as a client or admin to list a venue.</p>
                                <div class="flex justify-center space-x-4">
                                    <button type="button" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" onclick="window.location.href='/ventech_locator/client/client_login.php'">Login as Client</button>
                                    <button type="button" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600" onclick="window.location.href='/ventech_locator/users/user_signup.php'">Register</button>
                        ...
                        // If logged in as client/admin, redirect to add venue page
                        window.location.href = '/ventech_locator/client/add_venue.php';
                    }
                });
            }
